...
// PEGANDO A DATA
$data1 = explode('class="fa fa-clock-o">', $dadosSite);
$data2 = explode('</i>', $data1[1]);
...
// PEGANDO A IMAGEM
//$img3 = explode('<div class="mh-row mh-posts-digest-wrap mh-posts-digest-large clearfix"
//',$dadosSite);
//$img4 = explode('></div>',$img3[0]);
...
echo "<table>
  ...
  <tr>
  		<td><h3>".$img2[0]."<h3><h2>".$titulo2[0]."</h2><h5>".$descri2[0]."</h5><br><h2>".$titulo4[0]."</h2><br></td>
